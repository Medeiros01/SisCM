...
@section('content_header')
    <a href="{{url("orgao/create")}}"><h1 class="btn btn-primary">Novo Órgão</h1></a>
    <a href="{{url("orgaos/pdf")}}"><h1 class="btn btn-primary"><i class="fa fa-fw fa-print"></i> Imprimir lista de Órgãos</h1></a>
@stop
@endcan
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><a class="btn btn-primary" href="{{url('orgao/edita/'.$org->id)}}">Editar</a> | 
...
<div class="modal fade-lg" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
            ...
            function modalDesativa(id){
               ...
               $("#modalDesativa").attr("action", "{{ url('orgao/destroy')}}/"+id);
                    $('#Modal').modal();        
                };
            </script>
