...
@section('content_header')
    <a href="{{url('tiporegistro/create')}}"><h1 class="btn btn-primary">Novo Tipo de Registro</h1></a>
@stop
@endcan
...
@section('content')
                    ...
                    <tbody>
                        @if(isset($tiposregistro))
                            ...
                            <tr>
                                ...
                                @can('Admin')
                                <th>
                                    <a class="btn btn-primary" href="{{url('tiporegistro/edita/'.$tr->id)}}">Editar</a> | 
    ...
    <script>
        function modalDesativa(id){
            $("#modalDesativa").attr("action", "{{ url('tiporegistro/desativa')}}/"+id);
            $('#Modal').modal();        
        };
    </script>
