    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/compra/edita/'.$compra->id) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('st_notafiscal') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="st_notafiscal" type="text" class="form-control" required="true" placeholder="Insira o n° da nota Fiscal" name="st_notafiscal" value="{{ $compra->st_notafiscal }}"> 
                    ...
                    <div class="form-group{{ $errors->has('dt_compra') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="dt_compra" type="date" class="form-control" required="true" name="dt_compra" value="{{$compra->dt_compra}}"> 
                    ...
                    <div class="form-group{{ $errors->has('st_valor_compra') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="st_valor_compra" type="money" class="form-control" required="true"  name="st_valor_compra" value="{{ $compra->st_valor_compra }}"> 
