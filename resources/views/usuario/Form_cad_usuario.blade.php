                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/usuarios') }}">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password" type="password" required="true" class="form-control" placeholder="Senha" name="password"> 
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" required="true" class="form-control" placeholder="Confirmr Senha" name="password_confirmation"> 
