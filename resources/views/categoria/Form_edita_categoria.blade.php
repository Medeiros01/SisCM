    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/categoria/edita/'.$categoria->id) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('st_nome') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="st_nome" type="text" class="form-control" required="true" placeholder="Insira o Nome da Categoria" name="st_nome" value="{{$categoria->st_nome}}"> 
                    ...
                    <div class="form-group{{ $errors->has('st_cpf') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="st_descricao" type="text" class="form-control"  placeholder="Insira uma descrição para a categoria" name="st_descricao" value="{{$categoria->st_descricao }}"> 
