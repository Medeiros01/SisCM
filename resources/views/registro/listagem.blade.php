            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <div >
                        <form id="listaFeriasBySetor" class="form-horizontal" role="form" method="POST" action='{{ url("/registros/$tiporegistro/listagem") }}'>
                            {{csrf_field()}}
                        ...
                        <tr class="bg-primary">
                            ...
                            @endif
                            @if($tiporegistro == 2)
                                <th colspan="4">Lista de {{$registronome}}
                                </th>
                            @endif
                            <th>
                                @can('Edita')                            
                                    <div class="col-md-1">
                                        <form id="listaFeriasFilterExcel" class="form-horizontal" role="form" method="POST" action='{{ url("registros/$tiporegistro/excel") }}'>
                                            {{csrf_field()}}
                            ...
                            <th>
                                @can('Edita')                                  
                                    <div class="col-md-1">
                                        <form id="listaFeriasFilter" class="form-horizontal" role="form" method="POST" action='{{ url("registros/$tiporegistro/pdf") }}'>
                                            {{csrf_field()}}
