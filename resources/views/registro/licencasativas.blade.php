    ...
    <div class="col-md-12">
        <table class="table table-bordered">
            <thead>
                ...
                <th>                               
                    <div class="col-md-1">
                        <form id="listaFeriasFilter" class="form-horizontal" role="form" method="POST" action='{{ url("licencasativas/pdf") }}'>
                            {{csrf_field()}}
                ...
                <th>
                    <div class="col-md-1">
                            <form id="listaFeriasFilterExcel" class="form-horizontal" role="form" method="POST" action='{{ url("licencasativas/excel") }}'>
                                {{csrf_field()}}
