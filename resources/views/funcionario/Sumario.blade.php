                    ...
                    <tbody>
                        @if(isset($orgaos))
                            @forelse($orgaos as $o)
                                <tr>
                                    <th>{{$o->st_sigla}}</th>
                                    <th><a href="{{url('servidores/orgaos/'.$o->id)}}">{{$o->qtde}}</a></th>
                                </tr>
                                @empty
                                <tr>
                    ...
                    <tbody>
                        @if(isset($funcoes))
                            @forelse($funcoes as $f)
                                <tr>
                                    <th>{{$f->st_funcao}}</th>
                                    <th><a href="{{url('servidores/funcoes/'.$f->id)}}">{{$f->qtde}}</a></th>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="4" style="text-align: center;">Nenhum servidor cadastrado</td>
                        ...
                        @if(isset($graduacoes))
                            @forelse($graduacoes as $g)
                                <tr>
                                    ...
                                    <th><a href="{{url('servidores/graduacao/'.$g->id)}}">{{$g->qtde}}</a></th>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="4" style="text-align: center;">Nenhum servidor cadastrado</td>
                    ...
                    <tbody>
                        @if(isset($status))
                            @forelse($status as $s)
                                <tr>
                                    <th>{{$s->st_status}}</th>
                                    <th><a href="{{url('servidores/status/'.$s->id)}}">{{$s->qtde}}</a></th>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="4" style="text-align: center;">Nenhum servidor cadastrado</td>
