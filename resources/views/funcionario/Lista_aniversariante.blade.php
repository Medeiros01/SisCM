...
<div class="row">
    <div class="col-md-12">
        <form id="filtroListaFerias" class="form-inline pull-left" role="form" method="POST" action='{{ url("/servidor/aniversarios/listagem") }}'>
            {{csrf_field()}}
        ...
        <form class="form-inline pull-right" role="form" method="POST" action='{{ url("/servidor/aniversarios/pdf") }}'>
            {{csrf_field()}}
            <div class="form-group">
