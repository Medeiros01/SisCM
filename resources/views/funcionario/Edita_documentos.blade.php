    ...
    <form role="form" method="POST" action="{{ url('/servidor/edita/'.$servidor->id) }}">
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                ...
                <div class="form-group{{ $errors->has('dt_emissaorg') ? ' has-error' : '' }} col-md-2">
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                ...
                <div class="form-group{{ $errors->has('nu_zonatitulo') ? ' has-error' : '' }} col-md-2">
                ...
                <div class="form-group{{ $errors->has('nu_secaotitulo') ? ' has-error' : '' }} col-md-2">
                ...
                <div class="form-group{{ $errors->has('st_municipiotitulo') ? ' has-error' : '' }} col-md-2">
                ...
                <div class="form-group{{ $errors->has('dt_emissaotitulo') ? ' has-error' : '' }} col-md-2">
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                ...
                <div class="form-group{{ $errors->has('dt_vencimentocnh') ? ' has-error' : '' }} col-md-2">
                ...
                <div class="form-group{{ $errors->has('dt_emissaocnh') ? ' has-error' : '' }} col-md-2">
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                <div class="form-group{{ $errors->has('st_certificadomilitar') ? ' has-error' : '' }} col-md-2">
                    <label for="st_certificadomilitar">Número</label>
