        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" method="POST" action="{{ url('/servidor') }}">
                        {{ csrf_field() }}
                        <fieldset class="scheduler-border">    	
                                ...
                                <div class="form-group{{ $errors->has('st_sexo') ? ' has-error' : '' }} col-md-3">
                                    ...
                                    <div class="radio">
                                        <label class="radio-option">
                                            <input type="radio" name="st_sexo" id="st_sexo" value="Masculino" {{ (old('st_sexo') == 'Masculino') ? 'checked':''}}>
                                            Masculino
                                        </label>
                                        <label class="radio-option">
                                            <input type="radio" name="st_sexo" id="st_sexo" value="Feminino" {{ (old('st_sexo') == 'Feminino') ? 'checked':''}}>
                                            Feminino
                                        </label>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group{{ $errors->has('st_estadocivil') ? ' has-error' : '' }} col-md-2">
                                    ...
                                    <select id="st_estadocivil" name="st_estadocivil" class="form-control">
                                        <option value=""  selected>Selecione</option>
                                        <option value="Solteiro(a)" {{ old('st_estadocivil') == 'Solteiro(a)' ? 'selected':''}}>Solteiro(a)</option>
                                        <option value="Casado(a)" {{ old('st_estadocivil') == 'Casado(a)' ? 'selected':''}}>Casado(a)</option>
                                        <option value="Viúvo(a)" {{ old('st_estadocivil') == 'Viúvo(a)' ? 'selected':''}}>Viúvo(a)</option>
                                        <option value="Divorciado(a)" {{ old('st_estadocivil') == 'Divorciado(a)' ? 'selected':''}}>Divorciado(a)</option>
                                        <option value="Outro" {{ old('st_estadocivil') == 'Outro' ? 'selected':''}}>Outro</option>
                                    </select>
