                ...
                <div class="form-group{{ $errors->has('st_sexo') ? ' has-error' : '' }} col-md-3">
                    ...
                    <div class="radio">
                        <label class="radio-option">
                            <input type="radio" name="st_sexo" id="st_sexo" value="Masculino" {{ ($servidor->st_sexo == 'Masculino') ? 'checked':''}} required>
                            Masculino
                        </label>
                        <label class="radio-option">
                            <input type="radio" name="st_sexo" id="st_sexo" value="Feminino"{{ ($servidor->st_sexo == 'Feminino') ? 'checked':''}}>
                            Feminino
                        </label>
                    </div>
            ...
            <div class="row">
                ...
                <div class="form-group{{ $errors->has('st_estadocivil') ? ' has-error' : '' }} col-md-2">
                    ...
                    <select id="st_estadocivil" name="st_estadocivil" class="form-control" required>
                        <option value=""  selected>Selecione</option>
                        <option value="Solteiro(a)" {{ $servidor->st_estadocivil == 'Solteiro(a)' ? 'selected':''}}>Solteiro(a)</option>
                        <option value="Casado(a)" {{ $servidor->st_estadocivil == 'Casado(a)' ? 'selected':''}}>Casado(a)</option>
                        <option value="Viúvo(a)" {{ $servidor->st_estadocivil == 'Viúvo(a)' ? 'selected':''}}>Viúvo(a)</option>
                        <option value="Divorciado(a)" {{ $servidor->st_estadocivil == 'Divorciado(a)' ? 'selected':''}}>Divorciado(a)</option>
        ...
        <fieldset class="scheduler-border">    	
            ...
            <div class="row">
                ...
                <div class="form-group{{ $errors->has('st_email') ? ' has-error' : '' }} col-md-5">
                    ...
                    <input id="st_email" type="email" class="form-control" placeholder="Digite seu email" name="st_email" value="{{ $servidor->st_email }}"> 
