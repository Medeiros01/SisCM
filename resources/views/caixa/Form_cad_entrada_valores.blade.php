...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary">
            <div class="panel-heading">Cadastro de Entrada de Valores</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('caixa/cad_entrada_valores') }}">
                    {{ csrf_field() }}
                 

                    <div class="form-group{{ $errors->has('st_forma_pagamento') ? ' has-error' : '' }}">
                        <label for="st_forma_pagamento" class="col-md-4 control-label">Tipo de Entrada</label>
                        <div class="col-md-6">
