...
@section('content_header')
    <a href="{{url('tipoitens/create')}}"><h1 class="btn btn-primary">Novo Tipo de Item</h1></a>
@stop
@endcan
...
@section('content')
                    ...
                    <tbody>
                        @if(isset($tipositens))
                            ...
                            <tr>
                                ...
                                @can('Admin')
                                <th>
                                    <a class="btn btn-primary" href="{{url('tipoitens/edita/'.$tr->id)}}">Editar</a> | 
    ...
    <script>
        function modalDesativa(id){
            $("#modalDesativa").attr("action", "{{ url('tipoitens/desativa')}}/"+id);
            $('#Modal').modal();        
        };
    </script>
